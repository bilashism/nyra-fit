          ...
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              <p className="text-body-color text-base">
                Our mission is to place health and wellness at the centre of
                each individuals, teams and organizations.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="relative overflow-hidden rounded-lg">
                ...
                <div className="absolute bottom-5 left-0 w-full text-center">
                  <div className="relative mx-5 overflow-hidden rounded-lg bg-white py-5 px-3">
                    ...
                    <p className="text-body-color text-sm">Social Media</p>
                    <div>
                      <span className="absolute left-0 bottom-0">
                        <svg
                          width="61"
